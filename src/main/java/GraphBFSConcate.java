...
//        graph[3].add(new WeightedEdge(3,2, -1));
    ...
    static void bfs(ArrayList<WeightedEdge>[] weightedGraph, int vertex, boolean visit[], int start){
    ...
    public static void main(String[] args) {
        ...
        GraphBFSConcate.generateWeightedGraph(weightedGraph);
        boolean visit[] = new boolean[v];
        for (int i = 0; i<v; i++){
            if(!visit[i]){
                GraphBFSConcate.bfs(weightedGraph, v,visit, i);
            }
        }
